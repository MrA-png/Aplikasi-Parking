...
public class TambahKelas extends javax.swing.JFrame {
    ...
    public void Tambah_Data(){
        try{
            ...
            String sql="insert into kelas values('"+idkelas.getText()+"','"
                    +kelas.getText()+"')";
            stm.execute(sql);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(50, 120, 50, 17);
        jPanel1.add(kelas);
        kelas.setBounds(120, 110, 120, 30);
        jPanel1.add(idkelas);
        idkelas.setBounds(120, 70, 120, 30);

        jLabel3.setFont(new java.awt.Font("Tahoma", 3, 20)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Tambah Data Kelas");
        jPanel1.add(jLabel3);
        ...
        jPanel1.add(simpan);
        simpan.setBounds(100, 170, 90, 23);
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
       if(idkelas.getText().equals("")){
           JOptionPane.showMessageDialog(null,"iID Kelas harus diisi","informasi",JOptionPane.ERROR_MESSAGE);
